      ...
      <div className="flex justify-ceneter items-center gap-6">
        ...
        <ul className="flex justify-center items-center space-x-6">
          ...
          <li onClick={() => signOut()} style={{ cursor: "pointer" }}>
            ...
            />
            <span
              class="hover:opacity-200  opacity-0 bg-gray-500 transition-opacity text-white px-1 text-sm  rounded-md absolute left-3/6  border  
    -translate-x-1/4 translate-y-full m-4 tooltip"
            >
              Sign Out
            </span>
          </li>
